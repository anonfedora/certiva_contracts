...
mod tests {
    ...
    use unichain_contracts::certiva::Certiva::{University, Certificate, BulkCertificatesIssued};
    ...
    fn register_test_university(owner: ContractAddress, dispatcher: ICertivaDispatcher) -> ContractAddress {
    ...
    fn test_certificate_issued_event() {
        ...
        spy.assert_emitted(@array![(dispatcher.contract_address, Certiva::Event::certificate_issued(stored_cert.clone()))]);
    ...
    fn test_bulk_issue_certificates() {
        ...
        assert(stored_cert1.certificate_meta_data == "Student 1: Usman Alfaki, Degree: Computer Science", ' metadata 1');
        assert(stored_cert2.certificate_meta_data == "Student 2: Jethro Smith, Degree: Engineering", ' metadata 2');
    }
